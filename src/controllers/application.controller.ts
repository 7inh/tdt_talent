...
const ApplicationController = {
    ...
    setApplicationState: async (
        ...
        try {
            ...
            const databaseApplication = await ApplicationService.query.getById(
            ...
            const applicationUpdated = await ApplicationService.mutation.setApplicationState(
                applicationRequest
            );
