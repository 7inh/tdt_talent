...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("profile").insert([
        ...
        {account_id: 2, full_name: "FPT", phone_number: "0988764343", address: "TP Ho Chi Minh", description :"I'm Graphic Designer"},
        ...
        {account_id: 9, full_name: "Mamama", phone_number: "0948576644", address: "TP Ho Chi Minh", description :"Tester"},
    ]);
}
